...
# 模型配置
config_path = '/root/kg/bert/chinese_GAU-alpha-char_L-24_H-768/bert_config.json'
checkpoint_path = '/root/kg/bert/chinese_GAU-alpha-char_L-24_H-768/bert_model.ckpt'
dict_path = '/root/kg/bert/chinese_GAU-alpha-char_L-24_H-768/vocab.txt'
